...
(function() {
  const aliases = {
    "pantheon-d1": "pantheon",
    "pantheon-d3": "pantheon",
    "piazza-navona-d3": "piazza-navona",
    "ai-tre-scalini-d3": "ai-tre-scalini",
    "ai-tre-scalini-d4": "ai-tre-scalini",
    "drink-kong-d3": "drink-kong",
    "drink-kong-d4": "drink-kong",
    "pergamino-d2": "pergamino",
    "pergamino-d6": "pergamino"
  };
  for (const [alias, base] of Object.entries(aliases)) {
    if (PLACE_INFO[base]) {
      PLACE_INFO[alias] = PLACE_INFO[base];
    }
  }
})();
